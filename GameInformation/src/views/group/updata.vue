                    ...
                    <div class="centainer-left">
                        ...
                        <div style="width: 100%;height: 100%;margin-top: 20px;">
                            ...
                            <div
                                style="margin-top: 10px;margin-bottom: 10px;color: #fff;font-size: 16px;font-weight: bold;">
                                请选择需要发布的分组</div>
                            <el-select v-model="selectedValue" clearable placeholder="请选择分组"
                                style="width: 150px;">
                            ...
                            <div style="width: 100%;margin-top: 20px;display: flex;justify-content: center;">
                                ...
                                <el-button @click="postUpdate()" style="margin-left: 850px;">发布动态</el-button>
                            </div>
                        </div>
...
const postUpdate = async () => {
    flagChange.value = options.find(option => option.value === selectedValue.value);
    if(flagChange.value.label === '我的年度总结'){
        flag.value = 0;
    }else if(flagChange.value.label === '一枚生活碎片'){
        flag.value = 1;
    }
    ...
    console.log('formattedDate.value', formattedDate.value);
    await groupApi.groupPostUpdate(textarea.value, imageUrl.value, flag.value, auditing.value, userHeaderImage.value, username.value, formattedDate.value);
    //await groupApi.groupPostUpdate('今天天气好1221', 'https://tse1-mm.cn.bing.net/th/id/OIP-C.F-mUuote_55yfTJiYxkofQAAAA?rs=1&pid=ImgDetMain',
    //    0, 'false', 'https://c-ssl.dtstatic.com/uploads/blog/202209/12/20220912134623_63eb1.thumb.1000_0.jpeg', '作者AAA', '2025-02-19'
    //   );
}
