                ...
                <div class="centainer">
                    <div class="centainer-left">
                        <div class="centainer-left-container">
                            <div class="centainer-left-containerOne">
                                <div><button @click="returnBack()"
                                        style="background-color: #1c1c1e;border: none;color: #fff;font-weight: bold;font-size: 18px;cursor: pointer;">&lt;返回</button>
                                </div>
                                <div style="margin-top: 30px;color: #fff;font-weight: bold;font-size: 25px;">如何评价游戏《{{
                                    gameName }}》?
                                </div>
                            </div>
                            <div
                                style="margin-top:20px;margin-bottom: 5px;width: 100%;height: 50px;background-color: #1c1c1e;">
                                <div
                                    style="padding-top: 10px;margin-left: 20px;color: #fff;font-size: 16px;font-weight: bold;display: flex;align-items: center;">
                                    <span>{{ displayText }}</span>
                                    <!--<span style="margin-left: 640px;margin-right: 3px;cursor: pointer;">筛选</span><el-icon :size="size"
                                        :color="color">
                                        <Switch />
                                    </el-icon>-->
                                    <el-select v-model="selectedValue" clearable placeholder="全部选项"
                            ...
                            <div style="padding-left: 20px;padding-right: 20px;width: 100%;height: 50px;background-color: #1c1c1e;">
                                <div
                                    style="padding-top: 13px;color: #fff;font-size: 16px;font-weight: bold;display: flex;align-items: center;">
                                    <span style="">共{{ count }}条评论</span>
                                </div>
                            </div>
                            <div style="padding-left: 20px;padding-right: 20px;padding-bottom: 20px;width: 100%;height: 100%;background-color: #1c1c1e;">
                                <div style="width: 100%;height: 100%;background-color: skyblue;"></div>
                            </div>
                        </div>
                    </div>
...
const displayText = computed(() => {
    ...
    return selectedOption ? selectedOption.label : '全部选项';
});
