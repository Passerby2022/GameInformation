                    ...
                    <div class="centainer-left">
                        ...
                        <div style="width: 100%;height: 100%;margin-top: 20px;">
                            <div
                                ...
                                请选择需要发布的播客视频</div>
                            <el-upload class="avatar-uploader" action="http://localhost:3000/podcast"
                                :show-file-list="false" :on-success="handleVideoSuccess">
                                <video v-if="videoUrl" :src="videoUrl" controls class="avatar"></video>
                            ...
                            <div
                                style="margin-top: 10px;margin-bottom: 10px;color: #fff;font-size: 16px;font-weight: bold;">
                                请选择需要发布的视频封面</div>
                            <el-upload class="avatar-uploader" action="http://localhost:3000/podcastpic"
                            ...
                            <el-input v-model="title" style="width: 100%;" :rows="5" type="text"
                                placeholder="请输入你的标题......" />
                            <div style="width: 100%;margin-top: 150px;display: flex;justify-content: center;">
                                <el-button @click="pushUp()">&lt;返回</el-button>
                                <el-button @click="postUpdate()" style="margin-left: 825px;">发布播客视频</el-button>
                            </div>
                            <!--<div style="width: 100%;height: 350px;">
                                <img style="width: 100%;height: 100%;margin-top: 20px;"
                                    src="https://img95.699pic.com/photo/60009/1115.jpg_wh300.jpg!/fh/300/quality/90"
                                    alt="">
                            </div>-->
                        </div>
...
const postUpdate = async () => {
    ...
    const data = await contributeApi.contributePodcast(imageUrl.value, title.value, videoUrl.value, userHeaderImage.value, username.value, formattedDate.value, good.value, comment.value, auditing.value);
    if(data !== null && data !== undefined){
        alert('上传视频成功！！！');
    }
    //await contributeApi.contributePodcast('https://tse1-mm.cn.bing.net/th/id/OIP-C.F-mUuote_55yfTJiYxkofQAAAA?rs=1&pid=ImgDetMain', '今天天气好1221', 'http://localhost:3000/podcasts/9984791526e4a402011aa3d00.30',
    // 'https://c-ssl.dtstatic.com/uploads/blog/202209/12/20220912134623_63eb1.thumb.1000_0.jpeg', '作者AAA', '2025-2-20', '0', '0', 'true'
    //);
}
