                    ...
                    <div class="centainer-left">
                        ...
                        <div style="width: 100%;height: 100%;margin-top: 20px;">
                            <div
                                ...
                                请选择需要发布的视频</div>
                            <el-upload class="avatar-uploader" action="http://localhost:3000/videodata"
                            ...
                            <div
                                style="margin-top: 10px;margin-bottom: 10px;color: #fff;font-size: 16px;font-weight: bold;">
                                请选择需要发布的视频封面</div>
                            <el-upload class="avatar-uploader" action="http://localhost:3000/videopic"
                            ...
                            <div style="width: 100%;margin-top: 150px;display: flex;justify-content: center;">
                                ...
                                <el-button @click="postUpdate()" style="margin-left: 825px;">发布视频</el-button>
                            </div>
...
const postUpdate = async () => {
    ...
    //await contributeApi.contributePodcast(imageUrl.value, title.value, videoUrl.value, userHeaderImage.value, username.value, formattedDate.value, good.value, comment.value ,auditing.value);
    await contributeApi.contributeVideo('https://tse1-mm.cn.bing.net/th/id/OIP-C.F-mUuote_55yfTJiYxkofQAAAA?rs=1&pid=ImgDetMain', '今天天气好1221', 'http://localhost:3000/podcasts/9984791526e4a402011aa3d00.30',
