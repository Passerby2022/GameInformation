                    ...
                    <div class="centainer-left">
                        ...
                        <div style="width: 100%;height: 100%;margin-top: 20px;">
                            <div
                                ...
                                请选择需要发布的配图</div>
                            <el-upload class="avatar-uploader" action="http://localhost:3000/article"
                            ...
                            <div style="width: 100%;margin-top: 20px;display: flex;justify-content: center;">
                                ...
                                <el-button @click="postUpdate()" style="margin-left: 850px;">发布文章</el-button>
                            </div>
                        </div>
...
const postUpdate = async () => {
    ...
    const data = await contributeApi.contributeArticle(title.value, textarea.value, imageUrl.value, userHeaderImage.value, username.value, formattedDate.value, auditing.value);
    //await contributeApi.contributeArticle('今天天气好1221', '111111111', 'https://tse1-mm.cn.bing.net/th/id/OIP-C.F-mUuote_55yfTJiYxkofQAAAA?rs=1&pid=ImgDetMain',
    // 'https://c-ssl.dtstatic.com/uploads/blog/202209/12/20220912134623_63eb1.thumb.1000_0.jpeg', '作者AAA', '2025-02-19', 'false'
    //);
