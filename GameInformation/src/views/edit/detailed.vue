                ...
                <div class="centainer">
                    <div class="main-centainer-one">
                        <div class="main-centainer-one-son">
                            <div style="padding-right: 20px;padding-left: 20px;padding-top: 20px;width: 100%; height: 100%;">
                                <img style="width: 100%; height: 100%;" :src="articleImage" alt="">
                            </div>
                            <div style="padding-right: 20px;padding-left: 20px;padding-top: 20px;width: 100%; height: 90%;background-color: #1c1c1e;">
...
const count = ref(0);
const articleImage = localStorage.getItem('articleImage');
...
onUnmounted(() => {
    localStorage.removeItem('articleImage');
})
</script>
